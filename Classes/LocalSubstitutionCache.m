...
- (NSDictionary *)substitutionPaths
{
	return
		[NSDictionary dictionaryWithObjectsAndKeys:
			@"fakeGlobalNavBG.png", @"http://images.apple.com/global/nav/images/globalnav.png",
         @"fakeGlobalNavBG.png", @"http://images.apple.com/home/images/promo_ipad_mini.png",
		nil];
}
...
- (NSCachedURLResponse *)cachedResponseForRequest:(NSURLRequest *)request
{
	...
	// Load the data
	//
    NSLog(@"ssssss==%@",substitutionFilePath);
